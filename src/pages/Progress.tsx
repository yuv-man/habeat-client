              ...
              <>
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-1 text-green-100">
                          ...
                          <span className="text-sm">
                            {analytics.daysTracked} of {analytics.totalDays}{" "}
                            days tracked
                          </span>
                        </div>
                ...
                {analytics.daysTracked === 0 && (
                  <div className="bg-gray-50 rounded-xl p-8 text-center border border-gray-200">
                    ...
                    <p className="text-gray-600 text-sm">
                      Start tracking your meals and workouts to see your
                      progress here.
                    </p>
                  </div>
                )}
                ...
                <div className="bg-green-50 rounded-xl p-4 border border-green-100">
                  ...
                  <ul className="text-sm text-green-600 space-y-1">
                    <li>
                      • Track your meals consistently for accurate insights
                    </li>
                    <li>
                    ...
                    <li>
                      • Complete your planned workouts to burn extra calories
                    </li>
                  </ul>
                </div>
              </>
